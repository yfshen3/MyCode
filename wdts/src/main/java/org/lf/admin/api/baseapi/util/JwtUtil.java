...
public class JwtUtil {
    ...
    static {
        ...
        try {
            inputStream = JwtUtil.class.getResourceAsStream("/application.yml");
            Yaml yaml = new Yaml();
            Map<String, Object> loaded = (Map<String, Object>) yaml.load(inputStream);
            ENCRYPTION_KEY = ((Map<String, String>) (((Map<String, Object>) loaded.get("app")).get("jwt"))).get("encryption-key");
        } finally {
            if (inputStream != null) {
                try {
                    inputStream.close();
    ...
    public static String createJWT(String id, String subject, long ttlMillis) {
        ...
        claims.put("uid", "JXTMSGAPP1");
        claims.put("user_name", "admin");
        claims.put("nick_name", "JXTMSGAPP1N");
    ...
    private static SecretKey generalKey() {
        //本地配置文件中加密的密文
        String stringKey = ENCRYPTION_KEY;
        //本地的密码解码
